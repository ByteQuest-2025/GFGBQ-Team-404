...
git clone https://github.com/ByteQuest-2025/GFGBQ-Team-404.git
cd GFGBQ-Team-404/sentinal-demo
...
**3. Optional - Add Gemini AI Integration:**
...
3. **Test Detection**
   ...
   - Try speaking test phrases:
     - *"This is the IRS calling about your taxes"*
     - *"Your bank account will be suspended immediately"*
     - *"Please share your OTP for verification"*
     - *"We need your credit card CVV urgently"*

4. **Watch Real-Time Analysis**
   - View live transcript
   - Monitor risk score
   - See detected threat alerts
   - Architecture diagram animates as each step processes
...
- [ ] Add support for more languages (Hindi, Tamil, etc.)
- [ ] Implement Deepgram API integration for better accuracy
- [ ] Add call recording with export functionality
- [ ] Create browser extension version
- [ ] Add SMS/text scam detection
- [ ] Improve AI analysis with fine-tuned models
