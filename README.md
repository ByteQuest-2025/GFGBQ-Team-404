# Sentinel - Real-Time Audio Fraud Prevention
## GFGBQ-Team-404
...
### Problem
**Targetting the Vulnerable:** Fraudsters exploit elderly and digitally unaware users through phone calls.

**Psychological Pressure:** Scams use urgency, fear, and emotional manipulation which are difficult for users to identify in the heat of the moment.
